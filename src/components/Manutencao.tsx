      ...
      <div className="space-y-6">
        <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            No dia a dia, as piscinas devem ter pelo menos dois parâmetros bem alinhados para evitar problemas futuros em sua piscina, garantir que sua água fique cristalina pelo máximo de tempo possível, gastando o mínimo necessário.
          </p>
        </div>
        ...
        <div className="bg-indigo-50 dark:bg-indigo-900/20 p-4 rounded-lg">
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            O primeiro parâmetro deve ser seu pH. O pH é crucial estar estabilizado em uma média de 7,2 a 7,8 para que todos os demais produtos utilizados funcionem corretamente. Tentar qualquer tratamento com o pH desregulado resulta em desperdício de produto, já que não terão eficácia.
          </p>
        </div>
        ...
        <div className="bg-emerald-50 dark:bg-emerald-900/20 p-4 rounded-lg">
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            Por fim, garantir que o cloro atenda os níveis necessários para que a piscina fique sempre limpa e desinfectada de quaisquer micro organismos ou substâncias terceiras. Recomendamos para o dia a dia, o uso do <span className="font-semibold">Cloro 3 em 1 da Genco</span>.
          </p>
        ...
        <div className="bg-cyan-50 dark:bg-cyan-900/20 p-4 rounded-lg">
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            Também é interessante periodicamente realizar uma clarificação e aspiração da piscina, usando o <span className="font-semibold">Clarificante e Auxiliar de Filtração Genco</span>. Isso pode ser feito sempre que notar pequenas sujeiras na superfície da piscina, que não saem fácil da piscina.
          </p>
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm text-center italic">
            Após aplicar e aguardar por pelo menos 12 horas, faça a aspiração da piscina com a bomba na posição Filtrar.
          </p>
        </div>
