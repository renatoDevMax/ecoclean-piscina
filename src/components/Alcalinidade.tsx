...
export default function Alcalinidade({
  litragem,
  onVoltar,
}: AlcalinidadeProps) {
  ...
  return (
    <div className="w-full max-w-md bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-xl p-8">
      <h2 className="text-2xl font-light text-white mb-6 text-center">
        Tratamento para Alcalinidade
      </h2>

      <div className="space-y-6">
        <div className="bg-blue-900/20 p-4 rounded-lg">
          <p className="text-gray-300 mb-4">
            A alcalinidade é um parâmetro importante para o controle da água.
            Atuando como um "tampão" cuja função será a de estabilizar seu pH
            por mais tempo, impedindo variações bruscas, reduzindo a necessidade
            de correções a todo momento do pH.
          </p>

          <p className="text-gray-300 mb-4">
            Para estabilizar seu pH, recomendamos o uso do{" "}
            <span className="font-semibold">pH Certo, da Genco</span>.
          </p>
        </div>
        ...
        <div className="bg-indigo-900/20 p-4 rounded-lg">
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              Para medir sua alcalinidade atual, tenha um kit de teste de
              alcalinidade. Use o recipiente do teste de alcalinidade,
              preenchendo com a água da piscina. Evite pegar a água da
              superfíce, sempre preencha o recipiente com água a partir de uns
              30 centímetros da superfície da piscina.
            </p>

            <p>
              Com o recipiente preenchido na devida marcação, adicione 3 gotas
              do AT1. (reagente 1)
            </p>

            <p>
              Posteriormente, use o AT2 (reagente 2), pingando de gota em gota,
              diluindo a gota no recipiente movendo suavemente o recipiente. E
              conte quantas gotas são necessárias para trocar completamente a
              cor do recipente de roxo, para amarelo (alguns testes podem variar
              a cor inicial e final, mas sempre uma cor diferente no primeiro
              reagente, modificando para a segunda cor com o segundo reagente).
            </p>

            <p>
              Conte quantas gotas foram necessárias para a troca de cor, e
              informe o valor logo abaixo.
            </p>
          </div>
        </div>

        <div className="bg-blue-900/20 p-4 rounded-lg">
          <label className="block text-gray-300 text-center mb-3">
          ...
          <div className="flex justify-center mb-4">
            <input
              type="number"
              className="w-24 px-4 py-2 text-center border border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 bg-gray-700 text-white text-lg font-medium"
              value={gotas}
