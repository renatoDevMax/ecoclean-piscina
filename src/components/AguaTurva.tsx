      ...
      <div className="space-y-6">
        <div className="bg-blue-900/20 p-4 rounded-lg">
          <p className="text-gray-300 mb-4 text-center">
            Ixi... parece que sua piscina está com algum produto em excesso, ou
            com alguma reação química inesperada na água. Não se preocupe, vamos
            resolver.
          </p>

          <div className="bg-gray-800/50 p-4 rounded-lg mb-4">
            <p className="text-gray-300 mb-2">
              Esse problema pode ser causado por alguns fatores... entre eles
              estão o seguinte:
            </p>
        ...
        <div className="bg-blue-900/20 p-4 rounded-lg">
          <p className="text-gray-300 mb-4 text-center">
            Para resolver, primeiramente é necessário saber o quão turva a água
            está. Caso consiga ver o fundo da piscina, será necessário o uso do{" "}
            <span className="font-semibold">Clarificante Genco</span>.
          </p>
          ...
          <div className="text-center bg-gray-800/50 p-4 rounded-lg mb-4">
            ...
            <p className="text-gray-400 text-sm mt-1">de Clarificante Genco</p>
          </div>

          <div className="space-y-2 text-sm text-gray-400">
            <p>
              Depois de aplicar o produto, mantenha o filtro na posição
              RECIRCULAR, deixando o produto agir por 5 a 10 minutos.
            </p>
            <p>
              Em seguida, desligue a bomba, e deixe a piscina em repouso por
              aproximadamente 12 horas.
            </p>
            <p>
              Após isso, faça a aspiração da sujeira depositada no fundo da
              piscina, usando o filtro na posição de DRENAR.
            </p>
            <p>Ao concluir a drenagem, reponha a água drenada da piscina.</p>
          </div>
        </div>
        ...
        <div className="bg-blue-900/20 p-4 rounded-lg">
          <p className="text-gray-300 mb-4 text-center">
            Caso não seja possível ver o fundo da piscina, é recomendado usar o{" "}
            <span className="font-semibold">HTH Solução Água Turva</span>.
          </p>
          ...
          <p className="text-gray-400 text-sm">
            Aplique este produto seguindo os mesmos passos do Clarificante
            Genco.
          </p>
        </div>
        ...
        <div className="bg-gray-900/20 p-4 rounded-lg">
          <p className="text-gray-400 text-sm italic">
            Caso sua piscina esteja com pH elevado, ou seja, igual ou acima de
            8, com o passar de algum tempo ela deve voltar ao normal
            naturalmente, ou pode optar por usar um redutor de pH, como o
            Redutor de pH Líquido da Genco.
          </p>
        </div>
