...
export default function Resultado({ formData, calcularLitragem, calcularDosagem, onVoltar, onAguaVerde, onAguaTurva, onAlcalinidade, onOleosidade, onManutencao }: ResultadoProps) {
  return (
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm">
                de pH Barrilha Genco
              </p>
              <p className="text-xs text-gray-500 dark:text-gray-400 italic mt-4">
                Após adicionar o produto, aguarde pelo menos 2 horas antes de continuar o tratamento
              </p>
            </div>
          </div>
        ) : (
